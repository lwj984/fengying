package lwj.demo.simulate.general.wei.orange;
...
public class Simayi extends General {
     ...
     * 标签
     */
    private TagEnum[] tags = new TagEnum[] { TagEnum.MOU, TagEnum.FU };
    /**
     * 骑兵适性（1S,2A,3B,4C,5D）
     */
     ...
     * 弓兵适性（1S,2A,3B,4C,5D）
     */
    private int bowman = 2;
    /**
     * 枪兵适性（1S,2A,3B,4C,5D）
     */
    private int spearman = 1;
    /**
     * 机械适性（1S,2A,3B,4C,5D）
     */
     ...
     * 自带战法
     */
    private Tactics firstTactics = new Yingshilanggu();

    /****************  固定值 end *****************/

    public Simayi(int force, int intellect, int command, int speed, int star, Tactics secondTactics,
