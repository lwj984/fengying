...
import lwj.demo.dingding.util.DingTalkEncryptor;
...
public class CallbackController {
     ...
     * CorpId
     */
    private static final String SUITE_KEY = "ding427b24c031bd5c3dee0f45d8e4f7c288";
    ...
    public Object dingCallback(@RequestParam(value = "signature") String signature,
        ...
        try {
            ...
            DingTalkEncryptor dingTalkEncryptor = new DingTalkEncryptor("123456",
                    "P5pMzfmdJaAiFp5qKMod1eA5NSHCDhfGaAxNI4su1sJ", SUITE_KEY);
