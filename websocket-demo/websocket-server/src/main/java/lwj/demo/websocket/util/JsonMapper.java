 ...
 */
package lwj.demo.websocket.util;
...
public class JsonMapper extends ObjectMapper {
    ...
    public static JsonMapper alwaysMapper() {
        JsonMapper mapper = new JsonMapper(Include.ALWAYS).enableSimple();
        mapper.setPropertyNamingStrategy(PropertyNamingStrategy.SNAKE_CASE);
        return mapper;
    }
    ...
    /**
     * JSON字符串转换为对象 class_id转化为classId 
     * @param jsonString
     * @param t
     * @return
     */
    public static <T> T jsonToObject(String jsonString, Class<T> clazz) {
        ...
        try {
            ...
            return (T) jsonMapper.readValue(jsonString, clazz);
        } catch (IOException e) {
            logger.warn("parse json string error:" + jsonString, e);
            return null;
        }
